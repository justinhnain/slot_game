...
wins = {
  ...
  (1, 1) : 1
  (2, 2) : 1
  # (x, 11, y) : bonus_roll(x, y) with expected payout 30,
  # (x, y, z) : 15 when x = y = z
}

centre_11_win = list(filter((lambda combo : combo[1] == 11), combinations))
...
assert len(centre_11_win) == 50, "the number of bonus rounds is incorrect"
