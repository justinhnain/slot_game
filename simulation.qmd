...
A 95% t-confidence interval for the payout per game is $0.957314 \pm 0.0086837$, which captures the theoretical expected payout of approximately $0.958$.
...
bootstrap_stats |> 
  ...
  labs(
    ...
    subtitle = "The interval is a quite wider because the samples are 100x smaller than the original"
  ) +
